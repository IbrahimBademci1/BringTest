<?php
namespace Brohim\Bringapi\src\Contract\EasyReturn;

use Brohim\Bringapi\src\Contract\EasyReturn\LabelRequest as Contract;
 ...
 */
class LabelRequest extends ApiEntity
{
